...
public class EasyPermissions {
     ...
     */
    public static void onRequestPermissionsResult(final int requestCode, String[] permissions,
                                                  int[] grantResults, final Object object) {
        ...
        if (!denied.isEmpty()) {
            AlertDialog dialog = new AlertDialog.Builder(getActivity(object))
                    .setMessage(R.string.easy_permissions_denied_tip)
