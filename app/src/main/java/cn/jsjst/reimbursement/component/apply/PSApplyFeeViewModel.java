 ...
 * @since [模块]
 */
public class PSApplyFeeViewModel extends BaseViewModel<PSApplyFeeActivity> {

    public PSApplyFeeViewModel(PSApplyFeeActivity context) {
        super(context);
    }
    ...
    public void sendFinishEvent(){
        EventBus.getDefault().post(new EventApplyFinishMessage(EventApplyFinishMessage.TYPE_OFFICIAL));
    }
