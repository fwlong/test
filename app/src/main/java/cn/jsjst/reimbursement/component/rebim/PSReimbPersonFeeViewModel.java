 ...
 * @since [模块]
 */
public class PSReimbPersonFeeViewModel extends BaseViewModel<PSReimbPersonFeeActivity> {

    public PSReimbPersonFeeViewModel(
            PSReimbPersonFeeActivity context) {
        super(context);
    }
