 ...
 * @since [模块]
 */
public class BTApplyTimeAddrViewModel extends BaseViewModel<BTApplyTimeAddrActivity> {

    public BTApplyTimeAddrViewModel(
            BTApplyTimeAddrActivity context) {
        super(context);
    }
